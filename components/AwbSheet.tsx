    ...
    <div className="p-2 bg-white text-black font-mono text-[10px] leading-tight max-w-full overflow-hidden">
      <div className="border-2 border-black">
          ...
          <div className="w-1/2 border-r-2 border-black">
            ...
            <div className="flex border-b-2 border-black">
              <div className="w-1/3 border-r-2 border-black p-1 text-center">
                ...
                <p className="break-all">
                  {shipment.user_email.split("@")[0].toUpperCase()}
                </p>
              </div>
            ...
            <div className="border-b-2 border-black p-1">
              ...
              <div>
                ...
                {shipment.sender_address_pincode}
              </div>
              <div>
            ...
            <div className="p-1">
              ...
              <p className="font-bold mb-1">
                SHIPPER&apos;S AGREEMENT AND SIGNATURE
              </p>
              <p className="mb-2">Received for Waynex Logistics</p>
          ...
          <div className="w-1/2">
            ...
            <div className="flex border-b-2 border-black min-h-[140px]">
              <div className="w-1/2 border-r-2 border-black p-1">
                ...
                <div>
                  ...
                  {shipment.receiver_address_state}
                </div>
                <div>
                  <span className="font-bold">POST CODE: </span>
                  {shipment.receiver_address_pincode}
                </div>
                <div>
                  <span className="font-bold">TEL: </span>
                ...
                <div>
                  ...
                  {shipment.receiver_address_country}
                </div>
              </div>
              <div className="w-1/2 p-1">
            ...
            <div className="flex border-b-2 border-black">
              <div className="w-1/2 border-r-2 border-black p-1">
                ...
                <p className="font-bold mb-1">
                  DUTIES/TAXES/VALUE/CODE NOS.
                </p>
                <p className="font-bold mb-1">
                  VALUE DECLARED FOR CUSTOMS PURPOSE:
                </p>
                <p>
                  Amount: {shipment.total_with_tax_18_percent.toFixed(2)}{" "}
                  Currency: INR
                </p>
              </div>
              <div className="w-1/2 p-1 text-center">
                ...
                <p>
                  TOTAL WEIGHT: {shipment.package_weight_kg.toFixed(3)} KG
                </p>
              </div>
            </div>
            ...
            <div className="flex min-h-[115px]">
              <div className="w-1/2 border-r-2 border-black p-1">
                <p className="font-bold mb-2">
                  CODE NOS/VAT/GST/HS NOS. ECT FOR CLEARANCE/DUTIES
                </p>
                <table className="w-full border border-black mb-2 border-collapse">
                  <thead>
                    <tr className="border-b border-black">
                      <th className="border-r border-black p-1 w-1/4 text-[8px] font-bold bg-white">
                        QTY
                      </th>
                      <th className="border-r border-black p-1 w-1/2 text-[8px] font-bold bg-white">
                        DESCRIPTION
                      </th>
                      <th className="p-1 w-1/4 text-[8px] font-bold bg-white">
                        CODE NO.
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {goods.slice(0, 2).map((item, index) => (
                      <tr
                        key={index}
                        className={
                          index === 0 ? "border-b border-black" : ""
                        }
                      >
                        <td className="border-r border-black p-1 h-5 text-center text-[8px] align-middle">
                          {item.quantity}
                        </td>
                        <td className="border-r border-black p-1 text-[8px] align-middle">
                          {item.description.substring(0, 15)}
                        </td>
                        <td className="p-1 text-center text-[8px] align-middle">
                          {item.hsn_code}
                        </td>
                      </tr>
                    ))}
                    {goods.length < 2 && (
                      <tr
                        className={
                          goods.length === 1 ? "" : "border-b border-black"
                        }
                      >
                ...
                <p className="text-[7px] text-center">
                  All customs duties/taxes payable by consignee
                </p>
              </div>
              <div className="w-1/2 p-1">
        ...
        <div className="border-t-2 border-black p-1 text-[7px]">
          ...
          <p>
            1) Maximum liability for lost shipment $100 or invoice value
            whichever lower.
          </p>
          <p>2) Insurance available at additional cost.</p>
          <p>
            3) We are authorized to digitize the invoice for Customs Declaration
            purposes.
          </p>
        </div>
      </div>
