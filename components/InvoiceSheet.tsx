...
export default function InvoiceSheet({ shipment }: InvoiceSheetProps) {
  ...
  const goods =
    shipment.goods_details && shipment.goods_details.length > 0
      ...
      : [
          {
            description: "Courier Service Charge",
            quantity: 1,
            value: subtotal,
            hsn_code: "",
          },
      ...
      <div className="border border-gray-400 p-4 space-y-4">
        ...
        <div className="flex justify-between items-center pb-4 border-b border-gray-400">
          <div className="flex items-center space-x-4">
            ...
            />
            <div>
              <h1 className="text-2xl font-bold">WAYNEX LOGISTICS</h1>
              <p>
                Circular Road, Near Prita Lee Lesson School, Ashok Vihar,
                Kapurthala, Punjab – 144601
              </p>
              <p>
                Email: info@waynexshipping.com | Phone: +91 62832 79859
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4 pb-4 border-b border-gray-400">
          ...
          <div className="text-right">
            <p>
              <span className="font-bold">GSTIN:</span> 03AAECW3635L1Z8
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 pb-4 border-b border-gray-400">
          <div>
            ...
            <p>
              {shipment.sender_address_city}, {shipment.sender_address_state} -{" "}
