  ...
  useEffect(() => {
    ...
    if (session) {
      ...
      if (user.isEmployee || user.isAdmin) {
        window.location.href = user.isAdmin ? "https://admin.waynexshipping.com" : "/employee/dashboard";
      } else {
      ...
      fetch(`${API_URL}/api/auth/verify-token`, {
        ...
        .then((data) => {
          if (data.user) {
            ...
            if (data.user.isEmployee || data.user.isAdmin) {
              window.location.href = data.user.isAdmin ? "https://admin.waynexshipping.com" : "/employee/dashboard";
            } else {
              window.location.href = "/dashboard";
            }
          }
